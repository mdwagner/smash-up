      ...
      body class: "flex flex-col h-screen" do
        nav class: "bg-indigo-700 py-3 px-4 flex justify-between items-center" do
          ...
          div class: "flex items-center space-x-3" do
            empty_tag "img", src: "https://cdn2.iconfinder.com/data/icons/social-media-2421/512/Spotify-512.png", width: "55", alt: "Logo", class: "p-2"
          ...
          div class: "flex items-center space-x-3" do
            ...
            a href: "#", class: "inline-block py-2 px-4 text-yellow-700 bg-yellow-400 rounded hover:bg-yellow-300 hover:text-yellow-800 transition ease-in duration-150" do
              text "Sign Up"
            end
          end
        end
